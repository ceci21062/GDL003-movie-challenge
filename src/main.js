...
const blackpanther = ["tt1825683","tt1441105","tt8205250","tt4529214","tt4063610"]
...
const ghostRider = ["tt0259324","tt1071875"]
const blade = ["tt0120611","tt0187738","tt0359013"]
const elektra = ["tt0357277"]
...
venom.forEach( function(item) {
fetch('https://www.omdbapi.com/?i='+ item + '&apikey=98d30079')
  .then(res => res.json())
   .then(data => {
 document.getElementById('container14').innerHTML += movieCard(data);
});
});

thepunisher.forEach( function(item) {
fetch('https://www.omdbapi.com/?i='+ item + '&apikey=98d30079')
  .then(res => res.json())
   .then(data => {
 document.getElementById('container15').innerHTML += movieCard(data);
});
});

fantasticFour.forEach( function(item) {
fetch('https://www.omdbapi.com/?i='+ item + '&apikey=98d30079')
  .then(res => res.json())
   .then(data => {
 document.getElementById('container16').innerHTML += movieCard(data);
});
});
